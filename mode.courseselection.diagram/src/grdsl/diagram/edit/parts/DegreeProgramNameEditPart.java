 ...
 * @generated
 */
public class DegreeProgramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DegreeProgramNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.DegreeProgram_2002, getParserElement(),
					GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.DegreeProgramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
