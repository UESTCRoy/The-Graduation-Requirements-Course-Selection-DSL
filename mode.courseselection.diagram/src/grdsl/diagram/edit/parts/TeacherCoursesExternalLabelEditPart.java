 ...
 * @generated
 */
public class TeacherCoursesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.TeacherCoursesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public TeacherCoursesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.TeacherCourses_4006, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new TeacherCoursesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TeacherCoursesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TeacherCoursesExternalLabelFigure() {
			this.setText("teach");
		}
