 ...
 * @generated
 */
public class GraduationRequirementName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GraduationRequirementName2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return GrdslElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.GraduationRequirement_3001, getParserElement(),
					GrdslVisualIDRegistry
							.getType(grdsl.diagram.edit.parts.GraduationRequirementName2EditPart.VISUAL_ID));
		}
		return parser;
	}
