 ...
 * @generated
 */
public class CourseNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CourseNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.Course_2003, getParserElement(),
					GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.CourseNameEditPart.VISUAL_ID));
		}
		return parser;
	}
