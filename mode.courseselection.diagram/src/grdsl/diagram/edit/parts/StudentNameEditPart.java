 ...
 * @generated
 */
public class StudentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.Student_2001, getParserElement(),
					GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.StudentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
