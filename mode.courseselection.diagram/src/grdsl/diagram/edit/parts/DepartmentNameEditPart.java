...
public class DepartmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.Department_2004, getParserElement(),
					GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.DepartmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
