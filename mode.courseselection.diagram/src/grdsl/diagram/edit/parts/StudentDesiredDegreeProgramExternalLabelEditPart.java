 ...
 * @generated
 */
public class StudentDesiredDegreeProgramExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GrdslVisualIDRegistry
						.getType(grdsl.diagram.edit.parts.StudentDesiredDegreeProgramExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public StudentDesiredDegreeProgramExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.StudentDesiredDegreeProgram_4003,
	...
	*/
	protected IFigure createFigurePrim() {
		return new StudentDesiredDegreeProgramExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class StudentDesiredDegreeProgramExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public StudentDesiredDegreeProgramExternalLabelFigure() {
			this.setText("desiredDegreeProgram");
		}
