 ...
 * @generated
 */
public class CoursePrerequisitesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GrdslVisualIDRegistry.getType(
				grdsl.diagram.edit.parts.CoursePrerequisitesExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public CoursePrerequisitesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.CoursePrerequisites_4001, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new CoursePrerequisitesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CoursePrerequisitesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CoursePrerequisitesExternalLabelFigure() {
			this.setText("prerequisites");
		}
