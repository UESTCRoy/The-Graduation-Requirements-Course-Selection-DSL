 ...
 * @generated
 */
public class StudentSelectedCoursesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				GrdslVisualIDRegistry
						.getType(grdsl.diagram.edit.parts.StudentSelectedCoursesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public StudentSelectedCoursesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.StudentSelectedCourses_4004, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new StudentSelectedCoursesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class StudentSelectedCoursesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public StudentSelectedCoursesExternalLabelFigure() {
			this.setText("selectedCourses");
		}
