 ...
 * @generated
 */
public class GraduationRequirementNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GraduationRequirementNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.GraduationRequirement_2006, getParserElement(),
					GrdslVisualIDRegistry
							.getType(grdsl.diagram.edit.parts.GraduationRequirementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
