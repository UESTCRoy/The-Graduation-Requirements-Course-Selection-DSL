...
import grdsl.diagram.edit.policies.GrdslTextSelectionEditPolicy;
 ...
 * @generated
 */
public class GraduationRequirementRequiredCoursesExternalLabelEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(
				GrdslVisualIDRegistry.getType(
						grdsl.diagram.edit.parts.GraduationRequirementRequiredCoursesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public GraduationRequirementRequiredCoursesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new GrdslTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.GraduationRequirementRequiredCourses_4005,
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, GrdslEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new GraduationRequirementRequiredCoursesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GraduationRequirementRequiredCoursesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GraduationRequirementRequiredCoursesExternalLabelFigure() {
			this.setText("requiredCourse");
		}
