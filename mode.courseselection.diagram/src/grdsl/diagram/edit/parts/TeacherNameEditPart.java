 ...
 * @generated
 */
public class TeacherNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TeacherNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.Teacher_2005, getParserElement(),
					GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.TeacherNameEditPart.VISUAL_ID));
		}
		return parser;
	}
