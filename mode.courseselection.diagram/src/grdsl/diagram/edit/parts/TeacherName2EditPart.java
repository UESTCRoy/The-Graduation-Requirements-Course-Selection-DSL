 ...
 * @generated
 */
public class TeacherName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TeacherName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.Teacher_3003, getParserElement(),
					GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.TeacherName2EditPart.VISUAL_ID));
		}
		return parser;
	}
