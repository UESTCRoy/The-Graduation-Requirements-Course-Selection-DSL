 ...
 * @generated
 */
public class CourseDepartmentExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.CourseDepartmentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public CourseDepartmentExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.CourseDepartment_4002, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new CourseDepartmentExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CourseDepartmentExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CourseDepartmentExternalLabelFigure() {
			this.setText("belongTo");
		}
