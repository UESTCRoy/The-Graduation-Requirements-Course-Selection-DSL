 ...
 * @generated
 */
public class CourseName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CourseName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GrdslParserProvider.getParser(GrdslElementTypes.Course_3002, getParserElement(),
					GrdslVisualIDRegistry.getType(grdsl.diagram.edit.parts.CourseName2EditPart.VISUAL_ID));
		}
		return parser;
	}
