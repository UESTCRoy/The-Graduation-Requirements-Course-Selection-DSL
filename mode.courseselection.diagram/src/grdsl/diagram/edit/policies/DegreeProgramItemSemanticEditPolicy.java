 ...
 * @generated
 */
public class DegreeProgramItemSemanticEditPolicy extends GrdslBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (GrdslVisualIDRegistry.getVisualID(incomingLink) == StudentDesiredDegreeProgramEditPart.VISUAL_ID) {
					...
					case GraduationRequirement2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (GrdslVisualIDRegistry.getVisualID(
									outgoingLink) == GraduationRequirementRequiredCoursesEditPart.VISUAL_ID) {
