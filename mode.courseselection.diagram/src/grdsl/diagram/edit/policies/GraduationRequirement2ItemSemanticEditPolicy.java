 ...
 * @generated
 */
public class GraduationRequirement2ItemSemanticEditPolicy extends GrdslBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public GraduationRequirement2ItemSemanticEditPolicy() {
		super(GrdslElementTypes.GraduationRequirement_3001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (GrdslVisualIDRegistry
					.getVisualID(outgoingLink) == GraduationRequirementRequiredCoursesEditPart.VISUAL_ID) {
