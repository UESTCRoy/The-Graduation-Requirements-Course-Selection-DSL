...
/**
 * This is the item provider adapter for a {@link grdsl.Course} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCreditHoursPropertyDescriptor(object);
			addPrerequisitesPropertyDescriptor(object);
			addParentCoursePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrdslPackage.Literals.COURSE__COURSE_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrdslPackage.Literals.COURSE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrdslPackage.Literals.COURSE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Credit Hours feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCreditHoursPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_creditHours_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_creditHours_feature", "_UI_Course_type"),
				 GrdslPackage.Literals.COURSE__CREDIT_HOURS,
				 true,
				 false,
				 false,
	...
	protected void addPrerequisitesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_prerequisites_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_prerequisites_feature", "_UI_Course_type"),
				 GrdslPackage.Literals.COURSE__PREREQUISITES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Parent Course feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addParentCoursePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_parentCourse_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_parentCourse_feature", "_UI_Course_type"),
				 GrdslPackage.Literals.COURSE__PARENT_COURSE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTeacherPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_teacher_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_teacher_feature", "_UI_Course_type"),
				 GrdslPackage.Literals.COURSE__TEACHER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDepartmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_department_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_department_feature", "_UI_Course_type"),
				 GrdslPackage.Literals.COURSE__DEPARTMENT,
				 true,
				 false,
				 true,
				 null,
