...
/**
 * This is the item provider adapter for a {@link grdsl.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrdslPackage.Literals.DEPARTMENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrdslPackage.Literals.DEPARTMENT__COURSES);
			childrenFeatures.add(GrdslPackage.Literals.DEPARTMENT__TEACHERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrdslPackage.Literals.DEPARTMENT__COURSES,
				 GrdslFactory.eINSTANCE.createCourse()));

		newChildDescriptors.add
			(createChildParameter
				(GrdslPackage.Literals.DEPARTMENT__TEACHERS,
